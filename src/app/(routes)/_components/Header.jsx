...
function Header({ activeHome, activeBook, activeAbout, activeContact }) {
	...
	return (
		<div className='fixed left-0 right-0 top-0 border-b bg-white'>
			<div className='mx-auto flex max-w-[1200px] items-center justify-between py-4'>
				...
				<div className='grid grid-cols-3 place-content-center items-center gap-4'>
					<div className=' group relative h-5 w-5 '>
						...
						{isAuth ? (
							<div className='invisible  absolute right-0 top-[160%] z-50 min-w-80 bg-white before:absolute before:-right-2 before:-top-3 before:h-12 before:w-28    group-hover:visible'>
							...
							<div className=' invisible absolute right-0 top-[160%] z-50  min-w-64 bg-white before:absolute before:-right-2 before:-top-3 before:h-12  before:w-28 group-hover:visible'>
								<div className='rounded-md border '>
