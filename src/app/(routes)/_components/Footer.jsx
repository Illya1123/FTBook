		...
		<div className='  border-t bg-white'>
			...
			<div className='mx-auto  max-w-[1200px] '>
				<div className=' grid grid-cols-4 gap-6 py-4'>
					...
					<div>
						<h3 className='mx-4 font-bold'>Ứng dụng</h3>
						<ul className=' text-sm'>
							{/* <li className='my-4'>
								<Link href='/' className='mx-4  hover:text-blue'>
							...
							<div>
								<div className=' hover:bg-grayhover flex w-[160px] cursor-pointer items-center gap-5 rounded-full border px-3 py-2 '>
									<img
										src='https://cdn-icons-png.freepik.com/512/732/732076.png'
										alt='window'
										className='h-5 w-5'
									/>
									<p>Windows</p>
								</div>
								<div className=' hover:bg-grayhover mt-5 flex w-[160px] cursor-pointer items-center gap-5 rounded-full border px-3 py-2 '>
									<img
				...
				<div className=' py-2 text-center '>
					<p className=' text-sm text-gray-500'>© Copyright 2024 - FTBook</p>
				</div>
			</div>
